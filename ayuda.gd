...
var fotos = [
	preload("res://41.png"), # Foto 1 (Página 0)
	preload("res://42.png"), # Foto 2 (Página 1)
	preload("res://43.png"), # Foto 3 (Página 2)
	preload("res://44.png"), # Foto 4 (Página 3)
	preload("res://45.png")  # Foto 5 (Página 4)
]
...
func _on_button_1_pressed():
	pagina_actual = 0 # Le decimos: "Es la primera foto"
	cambiar_foto()
